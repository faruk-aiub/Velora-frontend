...
"Content-Type":"multipart/form-data",
 ...
 {value ? (
 <div className="relative group rounded-lg overflow-hidden border border-zinc-200 bg-zinc-50 aspect-video flex items-center justify-center">
 ...
 <div
 onClick={() => fileInputRef.current?.click()}
 className="border-2 border-dashed border-zinc-300 rounded-lg p-6 flex flex-col items-center justify-center gap-2 text-zinc-500 hover:bg-zinc-50 hover:text-zinc-900 transition-colors cursor-pointer"
 >
 {isUploading ? (
