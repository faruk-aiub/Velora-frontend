...
export const createColumns = (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div>{parentId ? <span className="text-xs text-zinc-500 border border-zinc-200 dark:border-zinc-800 rounded px-2 py-1">Has Parent</span> : <span className="text-xs bg-zinc-100 dark:bg-zinc-800 rounded px-2 py-1">Root</span>}</div>;
    }
  },
  {
    id: 'actions',
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => onDelete(category)} className="text-red-600 focus:text-red-600 focus:bg-red-50 dark:focus:bg-red-950/30">
